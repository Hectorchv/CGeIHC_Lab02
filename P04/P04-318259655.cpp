...
int main()
{
	...
	CrearCono(40, 2.0f);//�ndice 3 en MeshList
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		* 
		* 
		* AQUI COMIENZA EL EJERCICIO 2
		* 
		* COMENTAR LAS SIGUIENTES LINEAS DE
		* CÓDIGO PARA IMPLEMENTAR EL PRIMER
		* EJERCICIO
		* 
		*/
		...
		color = glm::vec3(0.663f, 0.510f, 0.353f);
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.484f, 0.408f, 0.337f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();
		...
		//Articulacion pata delantera izq 1
		model = modelBase;
		...
		//Articulacion pata delantera izq 2
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, -1.0f, 0.0f));
		...
		//Articulacion pata tracera izq 1
		model = modelBase;
		model = glm::translate(model, glm::vec3(0.0f, -2.0f, 1.5f));
		...
		//Articulacion pata tracera izq 2
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, -1.0f, 0.0f));
		...
		//Articulacion pata delantera der 1
		model = modelBase;
		model = glm::translate(model, glm::vec3(0.0f, 2.0f, -1.5f));
		...
		//Articulacion pata delantera der 2
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, -1.0f, 0.0f));
		...
		//Articulacion pata tracera der 1
		model = modelBase;
		model = glm::translate(model, glm::vec3(0.0f, -2.0f, -1.5f));
		...
		//Articulacion pata tracera der 2
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, -1.0f, 0.0f));
		...
		/*
		* 
		* AQUÍ TERMINA EL SEGUNDO EJERCICIO
		* 
		* COMENTAR LAS ANTERIORES LINEAS DE CODIGO
		* PARA IMPLEMENTAR EL PRIMER EJERCICIO
		* 
		*/
		...
		* 
		* 
		* AQUI COMIENZA EL PRIMER EJERCICIO
		* 
		* DESCOMENTAR LAS SEGUIENTES LINEAS DE CODIGO
		* PARA IMPLEMENTAR EL PRIMER EJERCICIO
		* 
		* 
		*/
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.5f, 0.75f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();
		...
		* 
		* 
		* AQUI TERMINA EL PRIMER EJERCICIO
		* 
		* DESCOMENTAR LAS ANTERIORES LINEAS DE CODIGO
		* PARA IMPLEMENTAR EL PRIMER EJERCICIO
		*/
		glUseProgram(0);
