...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-1.75f, -0.625f, -4.0f));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.325f, 0.325f, -3.25f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[1]->RenderMesh();
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.445f, -3.25f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[1]->RenderMesh();
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 1.55f, -4.0f));
		model = glm::scale(model, glm::vec3(2.0f, 1.25f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[0]->RenderMesh();

		//Dibujo triangulos cafes
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(1.75f, 0.115f, -4.0f));
		meshList[0]->RenderMesh();
